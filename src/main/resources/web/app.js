    ...
    function bootDemo() {
      ...
      state = {
        users: { 'abc-123': { uuid:'abc-123', name:'Steve', online:true, ranks:['admin'], primaryRank:'admin', permissions:[], meta:{}, disguiseName:'Herobrine', disguiseRank:'vip' }, 'def-456': { uuid:'def-456', name:'Alex', online:false, ranks:['default'], primaryRank:'default', permissions:[], meta:{} }, 'ghi-789': { uuid:'ghi-789', name:'Notch', online:true, ranks:['vip','admin'], primaryRank:'admin', permissions:[{node:'command.tp',value:true,mode:'literal',contexts:{}}], meta:{} } },
